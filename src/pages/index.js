                        ...
                        <Grid item sm={12} md={6}>
                            <ImgParagraph title="Вы творческий человек 👩🏻‍🎨 " imgPosition="right">
                               Вы увлекаетесь рисованием уже не первый год 
                                ...
                                <b> На курсе вы узнаете новые техники и определить свой собственный неповторимый стиль.</b> 
                            </ImgParagraph>
                            <ImgParagraph title="Никогда не рисовали 🙅🏻‍♀️" imgPosition="right">
                            Боитесь начать рисовать, так как думаете, что ничего не получится и разочаруетесь в себе.<br/>
                               <b> Потоковое Рисование вас удивит своей доступностью и легкостью. </b> 
                                <br/><br/><br/>
                            </ImgParagraph>
                        </Grid>
                        <Grid item sm={12} md={6}>
                            ...
                            Поздавляю! Вы особенный человек. Ваши способности очень ценны и важны миру.<br/>
                            <b>На курсе вы сможете еще больше их раскрыть и 
                         научиться управлять ими.
                             </b>  
                            
                            </ImgParagraph>
                            <ImgParagraph title=" Вы хотите усилить вашу интуицию 🌙  " imgPosition="right">
                             Сейчас у вас этап в жизни, когда необходимо прийти к внутреннему балансу и раскрыть свою чувственность.🌷
                            <br/> <b>Курс вас вдохновит и наполний радостю и волшебностью каждого мгновения.</b>
                            </ImgParagraph>
                        </Grid>
                    </Grid>
                </Section>
                ...
                <Section color="#d2d8f7" align="left">
                    ...
                    <Grid container spacing={4}>
                        <Grid item sm={12} md={6}>
                            ...
                            🌈 Вы полностью <b> оновите свою жизненную энергию </b> 
                             и восполните энергии тех цветов и вибраций, которых вам не хватало; <br/>
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                            🌺 Вы научитесь обращаться за ответами к своему подсознанию через рисунок и Существенно повысите качество вашей Жизни;
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                            Ваше творчество усилится потоковым состоянием. Вы получите настоящее удовольствие от процесса создания картины, исцеляющие вас;
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                            ✨ Примите уникальные настройки, которые <b>активируют ваши таланты </b> и расткоет <b>сенсорное видение</b>;
                            </ImgParagraph>
                        </Grid>
                        <Grid item sm={12} md={6}>
                            ...
                            <CardButton buttonContent="оплатить" href="https://secure.wayforpay.com/payment/art_standart">
                                ...
                                <Box textAlign="left">
                                    <ul>
                                        ...
                                        <li>
                                            <Typography variant="body1" component="span">
                                            Посвящение в Внутреннего Мастера.
                                            </Typography>
                                        </li>
                                    </ul>
                                </Box>
