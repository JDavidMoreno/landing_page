            ...
            <ThemeProvider theme={ theme }>
                ...
                <Section color="#f6ffde" align="center">
                    ...
                    <Grid container spacing={4} style={{textAlign: 'left'}}>
                        <Grid item sm={12} md={6}>
                            <ImgFit src={ portrait } alt="Tiana portrait" contain={ true } />
                        </Grid>
                        <Grid item sm={12} md={6} >
                    ...
                    <Grid container spacing={4}>
                        <Grid item sm={12} md={6}>
                            <ImgParagraph title="   " imgPosition="left">
                                🌈 Вы полностью <b>оновите свою жизненную энергию</b> и восполните энергии тех цветов и вибраций, которых вам не хватало;<br/>
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                                💎 Вы научитесь обращаться за ответами к <b>своему подсознанию</b> через рисунок и cущественно повысите качество вашей Жизни;
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                                🎨 Ваше творчество усилится потоковым состоянием и вы получите настоящее <b>удовольствие от процесса</b> создания ваших энергитических картины;
                            </ImgParagraph>
                            <ImgParagraph title="" imgPosition="left">
                                ✨ Примите уникальные настройки, которые <b>активируют ваши таланты</b> и раскроют <b>сенсорное видение</b>;
                            </ImgParagraph>
                        </Grid>
                        <Grid item sm={12} md={6}>
