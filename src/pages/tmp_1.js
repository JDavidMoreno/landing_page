    ...
    render() {
        ...
        return (
            <ThemeProvider theme={ theme }>
                ...
                <Section color="#d2d8f7" align="center">
                <Typography variant="body1" component="p" style={{paddingBottom: '1rem'}}>
                    <strong>10 видео-уроков</strong> 
                </Typography>
                <div class="auto-resizable-iframe">
                    <div>
                        <iframe src="https://www.youtube.com/embed/PDSccUYiPZo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <br />
                <Typography variant="body1" component="p" style={{paddingBottom: '1rem'}}>
                ...
                <div class="auto-resizable-iframe">
                    <div>
                        <iframe src="https://www.youtube.com/embed/Ii3JJee6EEY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                </Section>
                ...
                <Section color="#d2d8f7" align="left">
                    <Grid container spacing={4}>
                        <Grid item sm={12} md={6}>
                            <Sandwitch name="Елена" image={annaImage}>
